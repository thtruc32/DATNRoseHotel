...
$sql = "INSERT INTO chi_tiet_thiet_bi (ma_cttb, ma_phong, ma_thiet_bi, so_luong_trong_phong, tinh_trang) VALUE ('" .$ma_cttb. "', '" .$phong. "', '" .$thiet_bi. "', '" .$so_luong_trong_phong. "', '" .$tinh_trang. "')";
